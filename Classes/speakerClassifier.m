    ...
    methods
        ...
        function codeBooks = train(obj,speakerSamples)
            ...
            assert(obj.numFilters > obj.numCoeffs,['Invalid input',...
                ', must have at least 1 more filters than MFCCs.'])
            ...
            for i = 1:numSpeakers
                ...
                MFCCs = speechpreprocess(x,fs,obj.numFilters,...
                                         ...
                                         obj.strideDuration,...
                                         false);
                obj.speakerModels{i} = lbgClustering(MFCCs',...
                                                     obj.numClusters,.01);
        ...
        function [speakers,err] = classify(obj,testSamples,varargin)
            ...
            for i = 1:numTest
                ...
                MFCCs = speechpreprocess(x,fs,obj.numFilters,...
                                         ...
                                         obj.strideDuration,...
                                         false);
%                 testModels{i} = lbgClustering(MFCCs',obj.numClusters,.01);               
                lowestDist = inf;
                iLowest = 0;
                for j = 1:numSpeakers
...
%                     nearCentrDist = pdist2(codeBook,testModels{i},...
%                                                'euclidean','Smallest',1);
